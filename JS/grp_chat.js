...
// Arrow function to update the current time in the header
const updateTime = () => {
    const now = new Date();
...
// Arrow function to display chat messages
...
// Event listener for sending a message using arrow function
...
// Event listener for refresh button using arrow function
